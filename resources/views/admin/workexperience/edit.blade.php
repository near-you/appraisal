            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit Work Experience</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card card-secondary">
                <div class="card-header">
                    <h3 class="card-title">Edit Work Experience</h3>
                </div>
                <form id="workExperienceUpdate" method="POST"
                      action="{{ route('work-experience.update', ["work_experience" => $work_experience->id]) }}">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('job_title') is-invalid @enderror"
                                   value="{{ old('job_title') ?? $work_experience->job_title }}" name="job_title"
                                   id="inputJobTitle" placeholder="Enter Job Title">
                            @error('job_title')
                            <br>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('job_subtitle') is-invalid @enderror"
                                   value="{{ old('job_subtitle') ?? $work_experience->job_subtitle }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('from') is-invalid @enderror"
                                   value="{{ old('from') ?? $work_experience->from }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('to') is-invalid @enderror"
                                   value="{{ old('to') ?? $work_experience->to }}"
                                   oninput="if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('job_description') is-invalid @enderror"
                                      ...
                                      placeholder="Enter Job Description">{{ old('job_description') ?? $work_experience->job_description }}</textarea>
