...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('templatecss/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('templatecss/fontawsom-all.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('templatecss/style.css') }}" />
</head>
